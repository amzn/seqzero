...
class FairseqTask(object):
    ...
    def inference_step(
        self, generator, models, sample, prefix_tokens=None, constraints=None, sort_by_first_token = False, weight = 1.0,
    ):
        with torch.no_grad():
            return generator.generate(
                models, sample, prefix_tokens=prefix_tokens, constraints=constraints, sort_by_first_token = sort_by_first_token, weight = weight
            )
